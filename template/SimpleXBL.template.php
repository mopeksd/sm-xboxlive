...
function template_leaderboard()
{
    ...
    <div class="alert success">
        <span>', $txt['xbl_alert_deleted_member_success'], '</span>
    </div>';
    }
                    ...
                    <tr class="windowbg">
                        <td valign="top" width="20%" nowrap="nowrap">
                            <div class="smalltext" style="width: 100%;">
                                <span style="float: right;">', $context['xbl_stats_basic']['members'], '</span>', $txt['xbl_total_players'], ':
                            </div>
                            <div class="smalltext" style="width: 100%;">
                                <span style="float: right;"><img src="', $settings['images_url'] . '/xbl/gs.png" height="10" width="10" alt="" /> ', $context['xbl_stats_basic']['score'], '</span>', $txt['xbl_total_gamerscore'], ':
                            </div>
                            <div class="smalltext" style="width: 100%;">
                                <span style="float: right;"><img src="', $settings['images_url'], '/xbl/', $context['xbl_stats_basic']['reputation'], '.png" alt="" title="', $txt['xbl_total_reputation'], ': ', $context['xbl_stats_basic']['reputation'], '" /></span>', $txt['xbl_total_reputation'], ':
                            </div>
                            <div class="smalltext" style="width: 100%;">
                                <span style="float: right;">', $context['xbl_stats_basic']['gold'], '</span>', $txt['xbl_total_gold'], ':
                            </div>
                            <div class="smalltext" style="width: 100%;">
                                <span style="float: right;">', $context['xbl_stats_basic']['silver'], '</span>', $txt['xbl_total_silver'], ':
                            </div>
                            <div class="smalltext" style="width: 100%;">
                                <span style="float: right;">', $context['xbl_stats_basic']['gamescount'], '</span>', $txt['xbl_total_games'], ':
                            </div>
                        </td>
                        <td valign="top" width="20%" nowrap="nowrap">';
